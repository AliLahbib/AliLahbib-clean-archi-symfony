...
2. Clone this project: `git clone git@github.com:AliLahbib/AliLahbib-clean-archi-symfony.git`
...
### Manually
```bash
$ git clone git@github.com:AliLahbib/AliLahbib-clean-archi-symfony.git
$ cd clean-AliLahbib-clean-archi-symfony. 
